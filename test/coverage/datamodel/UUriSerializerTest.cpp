...
uprotocol::v1::UUri buildValidTestURI(const std::string& authority = "192.168.1.10") {
...
TEST_F(TestUUriSerializer, DeSerializeUUriStringWithIncorrectScheme) { // NOLINT
	...
	ASSERT_THROW(static_cast<void>(AsString::deserialize(uuri_as_string)), std::invalid_argument); // NOLINT
}
...
TEST_F(TestUUriSerializer, DeSerializeUUriStringWithWildcardArgument) { // NOLINT
	...
	ASSERT_NO_THROW(uuri = AsString::deserialize(uuri_as_string)); // NOLINT
	{
		...
		check_uri("*", UE_SERVICE_ID_WILDCARD, DEFAULT_VERSION_MAJOR, DEFAULT_RESOURCE_ID);
	}
	...
	ASSERT_NO_THROW(uuri = AsString::deserialize(uuri_as_string)); // NOLINT
	{
		...
		check_uri("192.168.1.10", UE_SERVICE_ID_WILDCARD, DEFAULT_VERSION_MAJOR, DEFAULT_RESOURCE_ID);
	}
	...
	ASSERT_NO_THROW(uuri = AsString::deserialize(uuri_as_string)); // NOLINT
	{
		...
		check_uri("192.168.1.10", UE_INSTANCE_ID_WILDCARD, DEFAULT_VERSION_MAJOR, DEFAULT_RESOURCE_ID);
	}
	...
	ASSERT_NO_THROW(uuri = AsString::deserialize(uuri_as_string)); // NOLINT
	{
		...
		check_uri("192.168.1.10", DEFAULT_UE_ID, VERSION_MAJOR_WILDCARD, DEFAULT_RESOURCE_ID);
	}
	...
	ASSERT_NO_THROW(uuri = AsString::deserialize(uuri_as_string)); // NOLINT
	{
		...
		check_uri("192.168.1.10", DEFAULT_UE_ID, DEFAULT_VERSION_MAJOR, RESOURCE_ID_WILDCARD);
	}
}
